    ...
    comidasPorCategoria: [
      {
        ...
        productos: [
          {
            nombre: 'Acelga',
            precio: 3, //  poner  precios  por  gramos
            puntaje: 100
          },
          {
            nombre: 'Apio',
      ...
      {
        nombre: 'Verduras_C',
        totalDeDieta: 1750, //  total  de  gramos
        productos: [
          {
            nombre: 'Batata',
            precio: 3,
      ...
      {
        nombre: 'Huevo',
        totalDeDieta: 770, //  total  de  gr.  Ojito  que  no  está  esto  en  las  condiciones  anteriores
        productos: [
          {
            nombre: 'Blanco',
            precio: 0.19166,
      ...
      {
        nombre: 'Frutas',
        totalDeDieta: 3500, //  total  de  gr.  Ojito  que  no  está  esto  en  las  condiciones  anteriores
        productos: [
          {
            nombre: 'Banana',
            precio: 0.079,
      ...
      {
        nombre: 'Cereales',
        totalDeDieta: 140, //  total  de  gr.  Ojito  que  no  está  esto  en  las  condiciones  anteriores  promedie  con  las  legumbres
        productos: [
          {
            nombre: 'Arroz',
            precio: 0.13415,
          ...
          },
          {
            ...
            nombre: 'Fideos  de  laminado  fino',
            precio: 3,
            puntaje: 100
          }, {
            nombre: 'Harinas  finas',
            precio: 0.0449,
            puntaje: 100
          }, {
            nombre: 'Maiz',
